...
class Section1(tk.Frame):
    def __init__(self, parent: tk.Frame) -> None:
        ...
        self.rowconfigure(0, weight=1, uniform="none")
        self.rowconfigure(1, weight=3, uniform="none")
        self.rowconfigure(2, weight=3, uniform="none")
        self.rowconfigure(3, weight=2, uniform="none")
    ...
    def _init_widgets(self):
        ...
        self.section_config.grid(row=1, column=0, sticky="nsew")

        self.section_routes = SectionRoutes(self)
        self.section_routes.grid(row=2, column=0, sticky="nsew")

        self.test_algorithm_button = tk.Button(self)
        self.test_algorithm_button["text"] = "Test Algorithm"
        self.test_algorithm_button.grid(row=3, column=0, sticky="nsew")
